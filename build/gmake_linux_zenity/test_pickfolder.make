...
ifeq ($(config),release_x64)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -L../lib/Release/x64 -Wl,-rpath,'$$ORIGIN/../lib/Release/x64' -m64 -s -lnfd
...
ifeq ($(config),release_x86)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -L../lib/Release/x86 -Wl,-rpath,'$$ORIGIN/../lib/Release/x86' -m32 -s -lnfd
  LINKCMD = $(CC) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
